...
my.gridSearch(XL[, feats.cut(feats)], algoLgb, expand.grid(lgbParams), verbose=T, folds=rep(3,200), resample.seed=2708, algo.seed=442)
stopCluster(cl)
...
validation.tqfold.parallel(XL, algoBlend, folds=rep(3,200), resample.seed=2708, algo.seed=442)
stopCluster(cl)
